                        ...
                        <tbody>
                            @foreach($ads as $ad)
                                <tr>
                                    ...
                                    <td>{{app()->getLocale() == 'ar' ? $ad->ad_name_ar : $ad->ad_name_en ?? 'بدون عنوان' }}</td>
                                    <td>{{ app()->getLocale() == 'ar' ? $ad->adCategory->name_ar : $ad->adCategory->name_en ?? 'غير محدد' }}</td>
                                    <td>
                                        <span class="badge 
                                    ...
                                    <td>{{ $ad->user->type == 'company' ? 'شركة' : 'فرد' }}</td>
