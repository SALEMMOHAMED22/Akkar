...
Route::group(
    ...
    function () {
        ...
        //  How It Works Routes
        Route::get('how-it-works' , [HowItWorksController::class , 'howItWorks'])->name('howItWorks.index');
        Route::post('how-it-works/update' , [HowItWorksController::class , 'updateHowItWorks'])->name('howItWorks.update');
