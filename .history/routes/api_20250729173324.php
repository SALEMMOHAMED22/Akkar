...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::get('/provider/profile/{id}', [ProviderController::class, 'getProviderProfileByProviderId']);
    Route::get('/provider/ads/{providerId}', [ProviderController::class, 'getProviderAdsByProviderId']);
