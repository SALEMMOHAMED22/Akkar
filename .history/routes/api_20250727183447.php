...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::get('/provider/profile/{id}' , [ProviderController::class, 'getProviderProfile']);
    Route::get('/provider/ads/{id}' , [ProviderController::class, 'getProviderAds']);
    Route::get('/provider/ads/reviews/{id}' , [ProviderController::class, 'getProviderAdsReviews']);
