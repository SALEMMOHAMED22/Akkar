...
Route::group(
    ...
    function () {
        ...
        Route::get('terms-and-conditions' , [PrivacyPolicyController::class , 'termsAndConditions'])->name('termsAndConditions.index');
        Route::post('terms-and-conditions/update' , [PrivacyPolicyController::class , 'updateTermsAndConditions'])->name('termsAndConditions.update');
