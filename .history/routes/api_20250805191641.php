...
Route::get('/settings', [GeneralController::class, 'settings']);
    Route::get('plans/categories' , [PlanController::class, 'getPlanCategories']);
    Route::get('plans-categories/plans/with-features' , [PlanController::class, 'getPlansWithFeatures']);
