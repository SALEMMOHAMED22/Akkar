...
Route::group(
    ...
    function () {
        ...
        Route::get('terms-and-conditions' , [Terms::class , 'termsAndConditions'])->name('termsAndConditions.index');
        Route::post('terms-and-conditions/update' , [Terms::class , 'updateTermsAndConditions'])->name('termsAndConditions.update');
