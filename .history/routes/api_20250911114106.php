...
Route::middleware(['setLocale'])->group(function () {
    ...
    // Get Job Titles & Company types 
    Route::get('/job-titles', [GeneralController::class, 'jobTitles']);
    Route::get('/company-types', [GeneralController::class, 'companyTypes']);
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    Route::get('/ad/filterMap/pdf', [AdController::class, 'filterMapPdf']);
    Route::get('/ad/filterMap/individual', [AdController::class, 'filterMapIndividual']);
    Route::get('/ad/filterMap/company', [AdController::class, 'filterMapCompany']);
    // ///////////////////////////////////////////////////////////////////////////////////////////////////////
    // End Ads Routes
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::get('/profile/identifies', [ProfileController::class, 'userIdentifies']);
        ...
        // Plans Routes 
        Route::get('plan-categories', [PlanController::class, 'getPlanCategories']);
        Route::get('plans/{catId}', [PlanController::class, 'getPlans']);
        Route::get('features-limits/{planId}', [PlanController::class, 'getFeaturesByPlanId']);
        Route::get('plan-categories/plans/with-features', [PlanController::class, 'getPlansWithFeatures']);
        Route::get('addons', [PlanController::class, 'getAddons']);
        ...
        //  Property Routes 
        Route::get('/properties', [PropertyController::class, 'index']);   // كل المنشور فقط
        Route::get('/properties/{id}', [PropertyController::class, 'show']); // منشور فقط
