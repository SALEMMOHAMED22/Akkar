...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user_identifies', function (Blueprint $table) {
            ...
            $table->string('tac_number')->nullable();
            $table->string('tax_record_front')->nullable();
            $table->string('tax_record_back')->nullable();
            $table->string('tax_card_front')->nullable();
            $table->string('tax_card_back')->nullable();
