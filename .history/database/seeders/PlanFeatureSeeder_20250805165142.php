...
class PlanFeatureSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $planFeatures = [
            ...
            [
                'plan_id' => 8 ,
                'name_ar' => 'تكامل مع انظمة الشركه' ,
                'name_en' => ' Integration with company systems',
            ],
            [
                'plan_id' => 8 ,
                'name_ar' => 'فريق دعم مخصص' ,
                'name_en' => ' Special support team',
            ],
            [
                'plan_id' => 8 ,
            ...
            [
                'plan_id' => 8 ,
                'name_ar' => 'ادراج في دليل المطورين المعنمدين' ,
                'name_en' => ' Add to the developer directory',
            ],
            [
                'plan_id' => 8 ,
                'name_ar' => 'تقارير استثمارية مفصلة' ,
                'name_en' => ' Detailed investment reports',
            ],
            [
                'plan_id' => 8 ,
                'name_ar' => 'امكانية تخصيص واجهة' ,
                'name_en' => ' Technical support via email',
            ],
        ];
    }
