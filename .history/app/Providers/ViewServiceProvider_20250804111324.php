            ...
            Cache::remember('site_settings', 60, function () {
                return Setting::firstOr(function () {
                    ...
                    return Setting::create([
                        ...
                        'site_desc_ar' => 'منصة عقارية متكاملة تجمع كل ما يحتاجه المستخدم العربي في عالم العقارات، في مكان رقمي واحد سهل الاستخدام. سواء كنت تبحث عن شقة للبيع، مكتب للإيجار، خدمات تمويل، أو حتى صيانة وتشطي– نحن نوفر لك ذلك من خلال شبكة واسعة من مقدمي الخدمات الموثوقين. ',
