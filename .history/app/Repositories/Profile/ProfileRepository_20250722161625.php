...
class ProfileRepository implements ProfileInterface
{
    ...
    public function identifiesStore(array $data)
    {
        ...
        if(isset($data['type']) && $data['type'] === 'individual'){
            ...
            $user_images = ['national_id_front', 'national_id_back', 'engineer_card_front', 'engineer_card_back'];
            ImageManger::uploadMultiImage('user_identifies', $data['identifies'], 'public');
