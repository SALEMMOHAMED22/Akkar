...
if (!function_exists('subscription_check')) {
    /**
     * فحص الميزة بدون أي استهلاك.
     *
     * @param int    $userId   رقم المستخدم
     * @param string $feature  'ads' | 'vr' | 'video'
     * @param int    $qty      الكمية المطلوبة (ads/vr). للفيديو تجاهلها.
     * @return array{ok: bool, remaining: int|null, reason: string|null}
     */
