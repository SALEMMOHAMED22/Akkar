...
class AdRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ad_sub_category_id' => ['required', 'exists:ad_sub_categories,id', new ValidSubCategory($this->input('ad_category_id'))],
            // 'ad_sub_sub_category_id' => 'nullable|exists:ad_sub_sub_categories,id',
            'ad_sub_sub_category_id' => ['nullable', 'exists:ad_sub_sub_categories,id', new ValidSubSubCategory($this->input('ad_sub_category_id'))],
