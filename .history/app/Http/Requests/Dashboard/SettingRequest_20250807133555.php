...
class SettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'promotion_video_url' => ['nullable', 'url' , 'max:500'],
            'logo_dark' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,webp', 'max:2048'],
            'logo_' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,webp', 'max:2048'],
            'favicon' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,webp', 'max:2048'],
            'site_banner' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,webp', 'max:2048'],
