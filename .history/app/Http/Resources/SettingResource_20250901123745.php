...
class SettingResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'logo_light' => asset($this->logo_light),
            'logo_dark' => asset($this->logo_dark),
            'favicon' => asset($this->favicon),
            'site_banner' => asset($this->site_banner),
            ...
            'working_hours' => app()->getLocale() == 'ar' ? $this->working_hours_ar : $this->working_hours_en ?? null,
