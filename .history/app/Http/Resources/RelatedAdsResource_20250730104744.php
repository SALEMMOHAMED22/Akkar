...
class RelatedAdsResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'category_name' => app()->getLocale() == 'ar' ? $this->adCategory->name_ar : $this->adCategory->name_en ?? null,
            'sub_category_name' => app()->getLocale() == 'ar' ? $this->adSubcategory->name_ar : $this->adSubcategory->name_en ?? null,
