...
class AdResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'ad_sub_sub_category' => $this->adSubSubCategory
                ? new SubSubCategoriesResource($this->adSubSubCategory)
                : null,
            'ad_name' => app()->getLocale() == 'en' ? $this->ad_name_en :  $this->ad_name_ar,
            'price' => $this->price ?? 0,
            'small_desc' => app()->getLocale() == 'en'
                ? ($this->small_desc_en ?? '')
                : ($this->small_desc_ar ?? ''),
            ...
            'availability' => $this->AdAvailability(),
            'status' => $this->status_te,
