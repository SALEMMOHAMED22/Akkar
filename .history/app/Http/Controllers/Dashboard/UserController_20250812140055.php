    ...
    public function usersIndividual()
    {
        ...
        return DataTables::of($usersIndividual)
            ...
            ->addColumn('image', function ($user) {
                $url = $user->image ?: 'images/default.png';
                return view('dashboard.datatable.image', ['url' => $url])->render();
            })
            ->addColumn('personal_photo', function ($user) {
                $url = optional($user->identifies)->personal_photo ?: 'images/default.png';
                return view('dashboard.datatable.image', ['url' => $url])->render();
            })
            ->addColumn('national_id_front', function ($user) {
                $url = optional($user->identifies)->national_id_front ?: 'images/default.png';
                return view('dashboard.datatable.image', ['url' => $url])->render();
            })
            ->addColumn('national_id_back', function ($user) {
                $url = optional($user->identifies)->national_id_back ?: 'images/default.png';
                return view('dashboard.datatable.image', ['url' => $url])->render();
            })
            ->addColumn('engineer_card_front', function ($user) {
                $url = optional($user->identifies)->engineer_card_front ?: 'images/default.png';
                return view('dashboard.datatable.image', ['url' => $url])->render();
            })
            ->addColumn('engineer_card_back', function ($user) {
                $url = optional($user->identifies)->engineer_card_back ?: 'images/default.png';
                return view('dashboard.datatable.image', ['url' => $url])->render();
            })
