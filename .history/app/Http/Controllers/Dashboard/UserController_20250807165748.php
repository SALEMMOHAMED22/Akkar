  ...
  $usersCompany = User::with('companytype')->where('type', 'company')->get();
        ...
        return DataTables::of($usersCompany)
            ...
            ->addColumn('actions', function ($user) {
                return view('dashboard.datatable.actions', ['show' => route('', $user->id), 'edit' => route('dashboard.users.edit', $user->id), 'delete' => route('dashboard.users.destroy', $user->id)'])->render();
            })
            ->addColumn('action', function ($user) {
                return view('dashboard.users.actions', compact('user'))->render();
            })
