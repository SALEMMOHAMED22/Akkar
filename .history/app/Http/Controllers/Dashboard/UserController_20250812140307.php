...
class UserController extends Controller
{
    ...
    $url = $user->identifies?->personal_photo ?? asset('default.png');
    return view('dashboard.datatable.image', ['url' => $url])->render();
})
->addColumn('national_id_front', function ($user) {
    $url = $user->identifies?->national_id_front ?? asset('default.png');
    return view('dashboard.datatable.image', ['url' => $url])->render();
})
->addColumn('national_id_back', function ($user) {
    $url = $user->identifies?->national_id_back ?? asset('default.png');
    return view('dashboard.datatable.image', ['url' => $url])->render();
})
->addColumn('engineer_card_front', function ($user) {
    $url = $user->identifies?->engineer_card_front ?? asset('default.png');
    return view('dashboard.datatable.image', ['url' => $url])->render();
})
->addColumn('engineer_card_back', function ($user) {
    $url = $user->identifies?->engineer_card_back ?? asset('default.png');
    return view('dashboard.datatable.image', ['url' => $url])->render();
})
