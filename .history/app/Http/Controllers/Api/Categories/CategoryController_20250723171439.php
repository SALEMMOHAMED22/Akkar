...
class CategoryController extends Controller
{
    ...
    public function getCategoryById(int $id){
        ...
        return apiResponse(200, 'Category fetched successfully', new CategoryResource($category));
    }
    public function getCatsWithSubCats(){
        ...
        return apiResponse(200, 'Categories and SubCategories fetched successfully', CategoryResource::collection($categories));
    }
}
