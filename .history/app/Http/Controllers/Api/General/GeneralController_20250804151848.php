...
use App\Http\Resources\TermsConditionsResoure;
...
class GeneralController extends Controller
{
    ...
    public function jobTitles(){
        ...
        return apiResponse(200, 'Job titles retrieved successfully', JobTitleResource::collection($jobTitles));
    }

    public function companyTypes(){
        $companyTypes = $this->generalRepo->getCompanyTypes();
        if(!$companyTypes){
            return apiResponse(404, 'Company types not found');
        }
        return apiResponse(200, 'Company types retrieved successfully', CompanyTypeResource::collection($companyTypes));
    }
    ...
    public function privacyPolicy(){
        ...
        return apiResponse(200, 'Privacy policy retrieved successfully', new PrivacyPolicyResource($privacyPolicy));
    }
    ...
    public function termsAndConditions(){
        ...
        return apiResponse(200, 'Terms and conditions retrieved successfully', new TermsConditionsResoure($termsAndConditions));
    }
}
