...
class AdController extends Controller
{
    ...
    public function getAdReviews($adId){
        ...
        return apiResponse(200 , 'Reviews retrieved successfully' , AdReviewResource::collection($reviews->load(['user'])));
    }
    ...
    public function getAdById($adId){
        ...
        return apiResponse(200 , 'Ad retrieved successfully' , new AdResource($ad->load(['adCategory', 'adSubCategory', 'adSubSubCategory' , 'user' , 'images' , 'userWorks' , 'adFiles' ])));
    }
}
