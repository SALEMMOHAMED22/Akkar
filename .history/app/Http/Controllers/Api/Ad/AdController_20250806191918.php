...
class AdController extends Controller
{
    ...
    public function storeAd(AdRequest $request) 
    {
        ...
        return apiResponse(200, 'Ad created successfully', new AdResource($ad->load(['adCategory', 'adSubCategory', 'adSubSubCategory', 'user', 'images', 'userWorks', 'adFiles' , 'reviews'])));
    }
    ...
    public function filterMapPdf(){
        ...
        return apiResponse(200, 'Ads retrieved successfully', AdFilterMa::collection($ads));
    }
