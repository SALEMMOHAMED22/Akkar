...
class AdController extends Controller
{
    ...
    public function storeAd(AdRequest $request)
    {
       $ad = $this->adRepo->storeAd($request->all());
        ...
        return apiResponse(200 , 'Ad created successfully' , new AdResource($ad->load(['adCategory', 'adSubCategory', 'user' , 'images' , 'userWorks' , 'adFiles' ])) );

    }

    public function getAll(){
        $ads = $this->adRepo->getAll();
        return apiResponse(200 , 'Ads' , AdResource::collection($ads->load(['adCategory', 'adSubCategory', '' ,  'user' , 'images' , 'userWorks' , 'adFiles' ])) );
    }
}
