...
class AdController extends Controller
{
    ...
    {
        $result = $this->adRepo->storeAd($request->all());
        ...
        return apiResponse(
            200,
            __('message.ad_created'),
            new AdResource(
                $result->load(['adCategory', 'adSubCategory', 'adSubSubCategory', 'user', 'images', 'userWorks', 'adFiles'])
            )
        );
    }
    ...
    public function getAll()
    {
        ...
        if (!$ads || $ads->isEmpty()) {
            return apiResponse(200, 'No ads found');
        }
