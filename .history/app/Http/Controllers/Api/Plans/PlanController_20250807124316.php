...
use App\Http\Resources\PlanFeaturesLimitsResource;
...
class PlanController extends Controller
{
    ...
    public function getFeaturesByPlanId($planId){
        $plan = $this->planRepository->getFeaturesByPlanId($planId);
        if (!$plan) {
            return apiResponse(404, 'Features not found');
        }
        return apiResponse(200, 'Features fetched successfully', new PlanFeaturesLimitsResource($features));
    }
