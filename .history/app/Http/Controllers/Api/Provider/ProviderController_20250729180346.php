...
class ProviderController extends Controller
{
    ...
    public function getProviderAdsByProvId(){
        $ads = $this->providerRepo->getProviderAdsByProvId();
     ...
     public function getProviderAdsReviewsByProvId(){
        $reviews = $this->providerRepo->getProviderAdsReviewsByProvId();
    ...
    public function getProviderStatisticsByProvId(){
        $stats = $this->providerRepo->getProviderStatistics();
