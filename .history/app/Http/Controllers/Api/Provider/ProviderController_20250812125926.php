...
class ProviderController extends Controller
{
    ...
    public function getProviderAds(string $status){
        
        dd('salem');
        $ads = $this->providerRepo->getProviderAds($status);
    ...
    public function getProviderProfileByProvId($provId) {
        ...
        $data = $this->providerRepo->getProviderProfileByProvId($provId);
    ...
    public function getProviderAdsByProvId($provId){
        $ads = $this->providerRepo->getProviderAdsByProvId($provId);
     ...
     public function getProviderAdsReviewsByProvId($provId){
        $reviews = $this->providerRepo->getProviderAdsReviewsByProvId($provId);
    ...
    public function getProviderStatisticsByProvId($provId){
        $stats = $this->providerRepo->getProviderStatisticsByProvId($provId);
