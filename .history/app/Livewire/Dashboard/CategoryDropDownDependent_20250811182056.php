...
class CategoryDropDownDependent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.category-drop-down-dependent' , [
            ...
            'subCats' => $this->category_id  ? AdSubCategory::where('ad_category_id' , $this->category_id)->get() : [],
            'subSubCats' => $this->subCat_id  ? AdSubSubCategory::where('ad_sub_category_id' , $this->subCat_id)->get() : [],
        ]);
    }
}
