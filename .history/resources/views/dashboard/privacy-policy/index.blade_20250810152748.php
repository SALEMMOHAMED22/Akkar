    ...
    <div class="card-body">
        <form action="{{ route('dashboard.privacyPolicy.update') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea id="desc_ar" name="content_ar" class="form-control summernote" rows="10">{!! old('content_ar', $privacy->content_ar ?? '') !!}</textarea>
                @error('content_ar')
            ...
            <div class="mb-3">
                ...
                <textarea id="desc_en" name="content_en" class="form-control summernote" rows="10">{!! old('content_en', $privacy->content_en ?? '') !!}</textarea>
                @error('content_en')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
