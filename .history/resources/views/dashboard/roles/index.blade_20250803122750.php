                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="javascript:void(0)" type="button" class="btn btn-danger delete-country-btn"
                                                            data-id="{{ $role->id }}"  onclick="if(confirm('Are you sure you want to delete this role?')){document.getElementById('delete-form-{{ $role->id }}').submit();} return false"> > 
