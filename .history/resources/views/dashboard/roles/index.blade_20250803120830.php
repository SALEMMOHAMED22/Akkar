            ...
            <div class="row mb-5">
                <div class="col-12 col-xl-12">
                    <div style="background-color: transparent !important" class="card">
                      ...
                      <ul class="dropdown-menu show" data-popper-placement="bottom-start" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(0px, 40.8px, 0px);">
