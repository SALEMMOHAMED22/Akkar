    ...
    <div class="container">
        <div class="card shadow-sm">
            <div class="card-header text-white text-center" style="background: linear-gradient(90deg, #6c757d, #495057);">
                <h5 class="mb-0"><i class="bi bi-info-circle me-2 text-warning"></i>{{ app()->getLocale() == 'ar' ? $aboutUs->title_ar : $aboutUs->title_en ?? __('dashboard.about_us' }) }}</h5>
            </div>
                ...
                <form action="{{ route('dashboard.aboutUs.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="title_ar" name="title_ar"
                            value="{{ old('title_ar', $aboutUs->title_ar ?? '') }}" class="form-control">
                        @error('title_ar')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="title_en" name="title_en"
                            value="{{ old('title_en', $aboutUs->title_en ?? '') }}" class="form-control">
                        @error('title_en')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if (!empty($aboutUs->image))
                            <div class="mt-2">
                                <img src="{{ asset($aboutUs->image) }}" alt="About Us Image" class="img-thumbnail"
                    ...
                    <ul class="nav nav-tabs mb-3" id="aboutTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="desc_ar_tab" data-bs-toggle="tab"
                                data-bs-target="#desc_ar_content" type="button" role="tab">
                                {{ __('dashboard.desc_ar') }}
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="desc_en_tab" data-bs-toggle="tab" data-bs-target="#desc_en_content"
