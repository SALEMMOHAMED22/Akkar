                ...
                <form action="{{ route('dashboard.termsAndConditions.update') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="title_ar" name="title_ar"
                            value="{{ old('title_ar', $te->title_ar ?? '') }}" class="form-control">
                        @error('title_ar')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="title_en" name="title_en"
                            value="{{ old('title_en', $te->title_en ?? '') }}" class="form-control">
                        @error('title_en')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if (!empty($te->image))
                            <div class="mt-2">
                                <img src="{{ asset($te->image) }}" alt="About Us Image" class="img-thumbnail"
