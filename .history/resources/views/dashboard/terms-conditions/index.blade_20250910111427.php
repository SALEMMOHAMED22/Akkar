    ...
    <div class="container py-4">
        <div class="card">
            <div class="card-header text-center">
                <h5 class="mb-0">{{ app()->getLocale() == 'ar' ? $terms->title_ar : $terms->title_en ?? __('dashboard.terms_and_conditions') }}</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('dashboard.termsAndConditions.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- Title Arabic -->
                    <div class="mb-3">
