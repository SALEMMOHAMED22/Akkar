    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('dashboard.settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label class="form-label">{{ __('dashboard.site_copyri_ar') }}</label>
                        <input readonly type="text" class="form-control" name="site_copyri_ar"
                            value="{{ $setting->site_copyri_ar }}">
                        @error('site_copyri_ar')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
