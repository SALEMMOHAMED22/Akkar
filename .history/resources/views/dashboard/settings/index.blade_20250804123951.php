                ...
                {{-- Site Description --}}
                 ...
                 <div class="row">
                    <div class="col-md-6">
                        ...
                        <textarea readonly class="form-control" name="site_desc_ar" rows="4">{{ $setting->site_desc_ar }}</textarea>
                        @error('site_desc_ar')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea readonly class="form-control" name="meta_description_en" rows="4">{{ $setting->site_desc_ar }}</textarea>
                        @error('meta_description_en')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
