              ...
              {{-- Address Row --}}
               ...
               {{-- meta description --}}
                <div class="row">
                    ...
                    <input readonly type="text" class="form-control" name="meta_description_ar"
                    ...
                    <input readonly type="text" class="form-control" name="meta_description_en"
                        value="{{ $setting->meta_description_ }}">
                    @error('promotion_video_url')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
