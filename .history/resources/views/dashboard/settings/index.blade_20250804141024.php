            ...
            <form action="{{ route('dashboard.settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea readonly class="form-control" name="meta_desc_en" rows="5">{{ $setting->site_desc_en }}</textarea>
                        @error('site_desc_en')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="file"  name="logo_image" id="logo-image" class="form-control">
                        @error('logo')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="file" name="favicon_image" id="favicon-image" class="form-control" >
                        @error('favicon')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
