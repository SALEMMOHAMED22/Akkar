...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">{{ __('dashboard.setting') }}</h4>
        </div>
        <div class="card-body">
            <form action="{{ route('dashboard.settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="col-md-6">
                    ...
                    <input readonly type="text" class="form-control" name="site_name[ar]"
                ...
                <div class="col-md-6">
                    ...
                    <input readonly type="text" class="form-control" name="site_name[en]"
