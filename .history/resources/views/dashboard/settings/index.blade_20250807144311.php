    ...
    <div class="card shadow" style="display: flex; justify-content: center;" >
        ...
        <div class="card-body  ">
            <form action="{{ route('dashboard.settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label class="form-label" >{{ __('dashboard.logo_light') }}</label>
                        <input type="file"  name="logo_light" id="logo-light-image" class="form-control">
                        @error('logo_light')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label" >{{ __('dashboard.logo_dark') }}</label>
                        <input type="file"  name="logo_dark" id="logo-dark-image" class="form-control">
                        @error('logo_dark')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label class="form-label" >{{ __('dashboard.site_banner') }}</label>
                        <input type="file"  name="site_banner" id="site-banner-image" class="form-control">
                        @error('site_banner')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
...
@push('js')
    ...
    $(function () {
        $('#logo-light-image').fileinput({
            ...
            initialPreviewAsData: true,
            initialPreview: ["{{ asset($setting->logo_light) }}"]
        });
        $('#logo-dark-image').fileinput({
            theme: 'fa5',
            language: lang,
            allowedFileTypes: ['image'],
            maxFileCount: 1,
            ...
            browseOnZoneClick: true,
            initialPreviewAsData: true,
            initialPreview: ["{{ asset($setting->logo_dark) }}"]
        });
        ...
        $('#site-banner-image').fileinput({
            ...
            browseOnZoneClick: true,
            initialPreviewAsData: true,
            initialPreview: ["{{ asset($setting->site_banner) }}"]
        });
    });
</script>
     <script>
