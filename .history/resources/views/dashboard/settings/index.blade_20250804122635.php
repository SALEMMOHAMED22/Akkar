            ...
            <form action="{{ route('dashboard.settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data"
              ...
              {{-- Address Row --}}
               <div class="row">
                    ...
                    <input readonly type="email" class="form-control" name="site_address_ar"
                    ...
                    @enderror
                     ...
                     <div class="col-md-6">
                    <label class="form-label">{{ __('dashboard.email_support_en') }}</label>
                    <input readonly type="email" class="form-control" name="site_address_en"
                        value="{{ $setting->site_address_ }}">
                    @error('email_support')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
