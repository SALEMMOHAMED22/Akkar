                ...
                <form action="{{ route('dashboard.admins.update', $admin->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input name="name" type="text" class="form-control" value="{{ old('name', $admin->name) }}" placeholder="Enter Name" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input name="email" type="email" class="form-control" value="{{ old('email', $admin->email) }}" placeholder="Enter Email" />
                        </div>
                    </div>
