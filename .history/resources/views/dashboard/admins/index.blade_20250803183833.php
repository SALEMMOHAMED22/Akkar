                            ...
                            @forelse($admins as $admin)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{-- <a  href="{{ route('dashboard.admins.changeStatus', $admin->id) }}"><i
                                                class="la @if ($admin->status == 'Active') la-toggle-on @else la-toggle-off @endif"></i>
                                                 Change Status
                                        </a> --}}

                                        <a href="{{ route('dashboard.admins.changeStatus', $admin->id) }}"
                                            class="btn btn-sm {{ $admin->status == 'Active' ? 'btn-success' : 'btn-secondary' }}"
                                            title="Click to {{ $admin->status == 'Active' ? '' : 'Activate' }}">
                                            <i
                                                class="la {{ $admin->status == 'Active' ? 'la-toggle-on' : 'la-toggle-off' }}"></i>
