    ...
    <div class="card-content">
        <div class="card-body">
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="mb-1">
                    <h5 class="mb-0">{{ __('dashboard.Faqs') }}</h5>
                </div>
                <br>
                    ...
                    @forelse ($faqs as $item)
                        <div class="accordion-item border border-success mb-2" id="faq_div_{{ $item->id }}">
                            <h2 class="accordion-header" id="heading_{{ $item->id }}">
                                <button
                                    class="accordion-button @if (!$loop->first) collapsed @endif text-success"
                            ...
                            <div id="collapse_{{ $item->id }}"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="float-end">
                                        ...
                                        <a data-bs-toggle="modal" data-bs-target="#faqEditModal_{{ $item->id }}"
                                            href="#">
                ...
                success: function(data) {
                    if (data.status == 'error') {
                        ...
                        $('.faq_row').prepend(` <h2 class="accordion-header" id="heading_">
                            ...
                            <div id="collapse_"
                                class="accordion-collapse collapse @if ($loop->first) show @endif"
                                aria-labelledby="heading_" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    ${answer}

                                    <div class="float-end">
                                        <a faq-id="" class="delete_confirm_btn me-2" href="#">
                                            <i class="la la-trash text-danger"></i>
                                        </a>
                                        <a data-bs-toggle="modal" data-bs-target="#faqEditModal_"
                                            href="#">
                                            <i class="la la-edit text-primary">Edit</i>
                                        </a>
                                    </div>
