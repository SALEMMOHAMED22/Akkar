            ...
            <div class="modal-body">
                ...
                <form action="" id="createFaq" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="question_[ar]" class="form-control" placeholder="{{ __('dashboard.question_ar') }}">
                    </div>

                    <div class="form-group mb-3">
                        <label>{{ __('dashboard.question_en') }}</label>
                        <input type="text" name="question[en]" class="form-control" placeholder="{{ __('dashboard.question_en') }}">
                    </div>

                    <div class="form-group mb-3">
                        <label>{{ __('dashboard.answer_ar') }}</label>
                        <textarea class="form-control" name="answer[ar]"></textarea>
                    </div>
