            ...
            <div class="modal-body">
                ...
                <form faq-id="{{ $item->id }}" action="" class="form update_faq_form" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="question[ar]" value="{{ $item->question_ar }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="question[en]" value="{{ $item->question_en }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="answer_en" rows="3">{{ trim($item->getTranslation('answer', 'en')) }}</textarea>
                    </div>
