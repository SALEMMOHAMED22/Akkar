...
@push('js')
    ...
    if (data.status == 'error') {
        ...
        const faqHtml = `
            <div class="accordion-item border border-success mb-2" id="faq_div_${faqId}">
        ...
        // إغلاق المودال
        const faqCreateModal = bootstrap.Modal.getInstance(document.getElementById('faqCreateModal'));
        faqCreateModal.hide();
    }
},
error: function(data) {
