    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form faq-id="{{ $item->id }}" action="" class="form " id = "update_faq_form" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="mb-3">
                        <label class="form-label">{{ __('dashboard.question_ar') }}</label>
                        <input type="text" name="question_ar" value="{{ $item->question_ar }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="question_en" value="{{ $item->question_en }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="answer_ar" rows="3">{{ trim($item->answer_ar) }}</textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">{{ __('dashboard.answer_en') }}</label>
                        <textarea class="form-control" name="answer_en" rows="3">{{ trim($item->answer_en) }}</textarea>
                    </div>
