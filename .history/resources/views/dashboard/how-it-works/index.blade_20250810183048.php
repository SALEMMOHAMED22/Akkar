    ...
    <div class="container py-4">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body mt-3">
                <form action="{{ route('dashboard.howItWorks.update') }}" method="POST"  enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="tab-content mt-3">
                        ...
                        <div class="tab-pane fade show active" id="ar" role="tabpanel">
                            <div class="mb-4">
                                <label class="form-label fw-bold">{{ __('dashboard.desc_ar') }}</label>
                                <textarea id="desc_ar" name="desc_ar" class="form-control summernote" rows="10">{!! old('desc_ar', $howItWorks->desc_ar ?? '') !!}</textarea>
                                @error('desc_ar')
                        ...
                        <div class="tab-pane fade" id="en" role="tabpanel">
                            <div class="mb-4">
                                <label class="form-label fw-bold">{{ __('dashboard.desc_en') }}</label>
                                <textarea id="desc_en" name="desc_en" class="form-control summernote" rows="10">{!! old('desc_en', $howItWorks->desc_en ?? '') !!}</textarea>
                                @error('desc_en')
                                    <div class="text-danger mt-1 small">{{ $message }}</div>
                                @enderror
                            </div>
