        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0 fw-bold text-center">
                    <i class="bi bi-shield-lock me-2"></i> {{ app()->getLocale() == 'ar' ? $howItWorks->title_ar : $howItWorks->title_en ?? __('dashboard.privacy_policy') }}
                </h5>
            </div>
                    ...
                    <div class="tab-content mt-3">
                        ...
                        <div class="tab-pane fade show active" id="ar" role="tabpanel">
                            <div class="mb-4">
                                ...
                                <textarea id="content_ar" name="content_ar" class="form-control summernote" rows="10">{!! old('content_ar', $howItWorks->content_ar ?? '') !!}</textarea>
                                @error('content_ar')
                        ...
                        <div class="tab-pane fade" id="en" role="tabpanel">
                            <div class="mb-4">
                                ...
                                <textarea id="content_en" name="content_en" class="form-control summernote" rows="10">{!! old('content_en', $howItWorks->content_en ?? '') !!}</textarea>
                                @error('content_en')
                                    <div class="text-danger mt-1 small">{{ $message }}</div>
                                @enderror
                            </div>
