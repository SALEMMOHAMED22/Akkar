        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0 fw-bold text-center">
                    <i class="bi bi-shield-lock me-2"></i> {{ app()->getLocale() == 'ar' ? $howItWorks->title_ar : $privacy->title_en ?? __('dashboard.privacy_policy') }}
                </h5>
            </div>
                ...
                <form action="{{ route('dashboard.privacyPolicy.update') }}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="title_ar" name="title_ar"
                            value="{{ old('title_ar', $privacy->title_ar ?? '') }}" class="form-control">
                        @error('title_ar')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="title_en" name="title_en"
                            value="{{ old('title_en', $privacy->title_en ?? '') }}" class="form-control">
                        @error('title_en')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if (!empty($privacy->image))
                            <div class="mt-2">
                                <img src="{{ asset($privacy->image) }}" alt="About Us Image" class="img-thumbnail"
