                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if (Str::length($contact->message) > 40)
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#messageModal{{ $contact->id }}">View</a>
                            ...
                            <td>
    <!-- Delete Button -->
    <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteModal{{ $contact->id }}">
        Delete
    </button>
    ...
    <div class="modal fade" id="deleteModal{{ $contact->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{ $contact->id }}" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete this message from <strong>{{ $contact->name }}</strong>?
                </div>
