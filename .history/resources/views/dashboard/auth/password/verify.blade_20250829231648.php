            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form id="formAuthentication" class="mb-3" action="{{ route('dashboard.password.verify.post') }}" method="POST">
                            @csr
                            <input hidden type="email" class="form-control" name="email" value="{{ $email }}">
                            <div class="mb-3">
                                <label for="otp" class="form-label">Code</label>
                                <input type="text" class="form-control" id="otp" name="code"
                                    placeholder="Enter Code Here" autofocus />
                                    @error('code')
