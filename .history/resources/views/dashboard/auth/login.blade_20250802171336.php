            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('dashboard.login.post') }}" id="formAuthentication" class="mb-3"  method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit">{{ __('dashboard.sign_in') }}</button>
                            </div>
                        </form>
                        {{-- <p class="text-center">
