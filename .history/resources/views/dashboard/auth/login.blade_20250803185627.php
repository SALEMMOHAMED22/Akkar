...
@section('content')
    ...
    <div class="container-fluid d-flex justify-content-end">
        <!-- Language Dropdown -->
        <div class="dropdown">
            <a class="btn btn-outline-secondary dropdown-toggle d-flex align-items-center" href="#" role="button" id="languageDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="flag-icon me-2 @if(app()->getLocale() == 'en') flag-icon-gb @else flag-icon-eg @endif"></i>
                {{ strtoupper(app()->getLocale()) }}
            </a>
                ...
                @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                    <li>
                        <a class="dropdown-item d-flex align-items-center" rel="alternate" hreflang="{{ $localeCode }}"
                            href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                            <i class="flag-icon me-2 @if($localeCode == 'en') flag-icon-gb @else flag-icon-eg @endif"></i>
                            {{ $properties['native'] }}
                        </a>
                    </li>
                @endforeach
