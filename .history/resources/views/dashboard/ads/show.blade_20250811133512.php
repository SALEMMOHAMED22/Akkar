...
<div class="container my-4">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            {{-- الوصف المختصر --}}
            <p><strong>{{ __('dashboard.small_desc') }}</strong> {{ app()->getLocale() == 'ar' ? $ad->small_desc_ar : $ad->small_desc_en }}</p>
            ...
            {{-- التصنيفات --}}
            <div class="row">
                <div class="col-md-4"><strong>{{ __('dashboard.category') }} : </strong> {{ app()->getLocale() == 'ar' ? $ad->adCategory->name_ar : $ad->adCategory->name_en  ?? '-' }}</div>
                <div class="col-md-4"><strong>{{ __('dashboard.sub_category') }} : </strong> {{ app()->getLocale() == 'ar' ? $ad->adSubCategory->name_ar : $ad->adSubCategory->name_en ?? '-' }}</div>
                <div class="col-md-4"><strong>{{ __('dashboard.sub_sub_category') }} : </strong> {{ app()->getLocale() == 'ar' ? $ad->adSubSubCategory->name_ar : $ad->adSubSubCategory->name_en ?? '-' }}</div>
            </div>
        </div>
    </div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body">
        ...
        <div class="border-top pt-3 mt-3">
            <p class="mb-2"><i class="bi bi-building me-2 text-primary"></i> <strong>اسم الشركة:</strong> {{ $ad->user->company_name }}</p>
            <p class="mb-2"><i class="bi bi-briefcase me-2 text-primary"></i> <strong>نوع الشركة:</strong> {{ $ad->user->companytype->name_ar ?? '-' }}</p>
            <p class="mb-0"><i class="bi bi-receipt me-2 text-primary"></i> <strong>الرقم الضريبي:</strong> {{ $ad->user->tax_number }}</p>
        </div>
        @endif
    </div>
</div>
