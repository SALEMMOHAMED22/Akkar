...
<div class="container my-4">
    ...
    <div class="card shadow mb-4">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            ...
            {{-- تغيير حالة الإعلان (للأدمن فقط) --}}
            @if(auth()->user() && auth()->user()->hasRole('admin'))
                <form action="{{ route('dashboard.ads.updateStatus', $ad->id) }}" method="POST" class="d-flex align-items-center">
                    @csrf
                    @method('PUT')
        ...
        <div class="card-body">
            <p><strong>السعر:</strong> {{ number_format($ad->price, 2) }} <span class="text-muted">ج.م</span></p>
