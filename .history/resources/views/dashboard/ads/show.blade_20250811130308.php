    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="d-flex align-items-center mb-3">
                @if($ad->user->image)
                    <img src="{{ asset('storage/' . $ad->user->image) }}" class="rounded-circle me-3" width="60" height="60">
                @else
                    <img src="{{ asset('images/default-avatar.png') }}" class="rounded-circle me-3" width="60" height="60">
                @endif
                <div>
